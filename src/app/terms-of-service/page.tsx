...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for The Afghanistan Affairs website.',
  alternates: {
      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <h1 className="text-[30px] text-[#333] pb-[10px] leading-[1em] font-[500]">
            The Afghanistan Affairs Terms of Service
          </h1>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Welcome to The Afghanistan Affairs! These Terms of Service (“Terms”) govern your access
            to and use of our website, services, and platforms (collectively, “Services”), provided
            by The Afghanistan Affairs (“we,” “us,” or “our”). By accessing or using our Services,
          ...
          <ul className="list-inside ml-[1.5em] space-y-[4px]">
            ...
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              Using the Services to solicit funds outside the scope of The Afghanistan Affairs’
              mission.
            </li>
          </ul>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            are the property of The Afghanistan Affairs or its licensors. You agree not to use,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            controlled by The Afghanistan Affairs. We are not responsible for the content, privacy
            policies, or practices of any third-party websites or services. You acknowledge and
            agree that The Afghanistan Affairs shall not be liable for any damages or loss caused by
            or in connection with your use of any third-party websites or services.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Our Services are provided on an “as is” and “as available” basis. The Afghanistan
            Affairs makes no representations or warranties of any kind, express or implied,
            regarding the use or the results of our Services in terms of accuracy, reliability, or
            otherwise. The Afghanistan Affairs disclaims all warranties, express or implied,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            To the fullest extent permitted by law, The Afghanistan Affairs shall not be liable for
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            You agree to indemnify, defend, and hold harmless The Afghanistan Affairs, its officers,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Email:{' '}
            <a href="mailto:info@theafghanistanaffairs.org" className="text-[#007bff] underline">
              info@theafghanistanaffairs.org
            </a>
          </p>
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Thank you for supporting The Afghanistan Affairs and for complying with these Terms of
            Service.
          </p>
        </div>
      </div>
