...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for The Afghanistan Affairs website.',
  alternates: {
    ...
    <div className="pt-[140px] pb-[54px]">
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            At The Afghanistan Affairs, accessible from https://theafghanistanaffairs.org, your
            privacy is one of our primary concerns. This Privacy Policy document contains types of
            information we collect and record, and how we use it. By using our website, you hereby
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Our website address is: https://theafghanistanaffairs.org
          </p>
          ...
          <ul className="list-inside list-disc space-y-[4px] pb-[1em]">
            ...
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              ...
              controlled by Microsoft, not The Afghanistan Affairs.
            </li>
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            To exercise these rights, please contact us at info@theafghanistanaffairs.org.
          </p>
